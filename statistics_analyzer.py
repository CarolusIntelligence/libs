...
def basic_report(columns, data, batch_size=1000):
    ...
    for column in columns:
        ...
        result_list.append(f'{column}: mean = {overall_mean}, median = {global_median}, mode = {global_mode}, std = {overall_std}, min = {global_min}, max = {global_max}, q1 = {global_q1}, q3 = {global_q3}, IQR = {global_iqr}, variance coef = {global_vc}')
